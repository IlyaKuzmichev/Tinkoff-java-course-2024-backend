...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord>
    implements Record4<Long, LinkTypeEnum, String, OffsetDateTime> {
     ...
     */
    public void setLinkType(@NotNull LinkTypeEnum value) {
        set(1, value);
    }
    ...
    @Override
    @NotNull
    public Row4<Long, LinkTypeEnum, String, OffsetDateTime> valuesRow() {
    ...
    @Override
    @NotNull
    public Field<LinkTypeEnum> field2() {
    ...
    @Override
    @NotNull
    public LinkTypeEnum component2() {
        return getLinkType();
    }
    ...
    @Override
    @NotNull
    public LinksRecord value2(@NotNull LinkTypeEnum value) {
        setLinkType(value);
        return this;
    }
     ...
     */
    @ConstructorProperties({"id", "linkType", "url", "lastCheck"})
    public LinksRecord(
        @Nullable Long id,
        @NotNull LinkTypeEnum linkType,
        @NotNull String url,
     ...
     * Create a detached, initialised LinksRecord
     */
    public LinksRecord(edu.java.domain.jooqcodegen.tables.pojos.Links value) {
        super(Links.LINKS);
