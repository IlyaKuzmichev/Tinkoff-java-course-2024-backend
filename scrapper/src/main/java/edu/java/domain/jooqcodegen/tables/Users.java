...
import edu.java.domain.jooqcodegen.tables.records.UsersRecord;
...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>USERS.USER_STATUS</code>.
     */
    public final TableField<UsersRecord, UserStatusEnum> USER_STATUS = createField(DSL.name("USER_STATUS"),
        SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field(DSL.raw("'base'"), SQLDataType.VARCHAR))
            .asEnumDataType(edu.java.domain.jooqcodegen.enums.UserStatusEnum.class),
        this,
        ""
    );
     ...
     */
    public <U> SelectField<U> mapping(Function2<? super Long, ? super UserStatusEnum, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function2<? super Long, ? super UserStatusEnum, ? extends U> from
    ) {
