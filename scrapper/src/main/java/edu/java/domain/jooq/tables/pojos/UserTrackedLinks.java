...
public class UserTrackedLinks implements Serializable {
    ...
    public UserTrackedLinks(UserTrackedLinks value) {
    ...
    public boolean equals(Object obj) {
        ...
        final UserTrackedLinks other = (UserTrackedLinks) obj;
        if (this.userId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UserTrackedLinks (");
